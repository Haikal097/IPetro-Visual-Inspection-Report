      ...
      {open && (
        <div className="absolute right-0 mt-2 w-[360px] rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-950 z-50">
          ...
          <div className="max-h-[360px] overflow-auto">
            ...
            {recent.length ? (
              recent.map((n) => (
                <div key={n.id} className="px-4 py-3 border-b border-gray-50 dark:border-gray-900">
              ...
              <div className="px-4 pb-4 text-sm text-gray-500 dark:text-gray-400">No notifications yet.</div>
            )}
          </div>
